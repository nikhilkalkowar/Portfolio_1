					...
					<div className="colorlib-narrow-content">
						...
						<div className="row">
							<div className="col-md-4 animate-box" data-animate-effect="fadeInLeft">
								<div className="project" style={{backgroundImage: 'url(images/img-4.jfif)'}}>
									<div className="desc">
										<div className="con">
											<h3><a href="https://www.codechef.com/users/nikhil3230">Codechef</a></h3>
											<p className="icon">
												<span><a href="https://www.codechef.com/users/nikhil3230"><i className="icon-eye" />View Profile</a></span>
											</p>
										</div>
									</div>
								</div>
							...
							<div className="col-md-4 animate-box" data-animate-effect="fadeInRight">
								<div className="project" style={{backgroundImage: 'url(images/img-5.png)'}}>
									<div className="desc">
										<div className="con">
											<h3><a href="https://www.hackerrank.com/profile/nikhilkalkotwar1">Hackerrank</a></h3>
											<p className="icon">
												<span><a href="https://www.hackerrank.com/profile/nikhilkalkotwar1"><i className="icon-eye" />View Profile</a></span>
											</p>
										</div>
									</div>
								</div>
						...
						<div className="row">
							<div className="col-md-12 animate-box">
								<p><a href="https://www.stopstalk.com/user/profile/Nikhil3032" className="btn btn-primary btn-lg btn-load-more">View All Profiles <i className="icon-reload" /></a></p>
							</div>
						</div>
					</div>
				</section>
